...
# ---------------------- Idc --------------------------------
        ...
        if(rawIbatt1 >= 2.523):
            Ibatt1 = (rawIbatt1 - 2.523)/ 0.016
            if(Ibatt1 < 0):
                Ibatt1 = 0.0
        elif(rawIbatt1 < 2.523):
            Ibatt1 = 0.0
        Ibatt1 = convert2dot(Ibatt1,2)

        if(rawIbatt2 >= 2.53):
            Ibatt2 = (rawIbatt2 - 2.53)/ 0.016
            if(Ibatt2 < 0):
                Ibatt2 = 0.0
        elif(rawIbatt2 < 2.53):
            Ibatt2 = 0.0
        ...
        if(rawIcharger >= 2.521):
            Icharger = (rawIcharger - 2.521)/ 0.016
            if(Icharger < 0):
                    Icharger = 0.0
        elif(rawIcharger <  2.521):
            Icharger = 0.0
        Icharger = convert2dot(Icharger,2)

        if(rawIinverter >= 2.517):
            Iinverter = (rawIinverter - 2.517)/ 0.010
            if(Iinverter < 0):
                Iinverter = 0.0
        elif(rawIinverter <  2.517):
            Iinverter = 0.0
